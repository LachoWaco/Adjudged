...
namespace Valve.VR.InteractionSystem
{
	...
	public class VRAxisRotationThrowable : MonoBehaviour
	{
		[EnumFlags]
		...
		private void OnAttachedToHand(Hand hand)
		{
			...
			if (GetComponent<VRAxisRotationScript>())
			{
				GetComponent<VRAxisRotationScript>().Grabbed();
		...
		private void OnDetachedFromHand(Hand hand)
		{
			...
			if (GetComponent<VRAxisRotationScript>())
			{
				GetComponent<VRAxisRotationScript>().Released();
				return;
			}

			if (GetComponent<ReturnToPositionAfterPickup>())
			{
				GetComponent<ReturnToPositionAfterPickup>().StartReturning();
			}
