...
namespace Valve.VR.InteractionSystem
{
	...
	public class FreezeableCircularDrive : MonoBehaviour
	{
		public enum Axis_t
		{
			XAxis,
		...
		/// <summary>
		/// allows the drive to be fozeon from external scripts
		/// </summary>
		public void FreezeExternal()
		{
			frozen = true;
			frozenAngle = outAngle;
			frozenHandWorldPos.Set(0.0f, 0.0f, 0.0f);
		...
		/// <summary>
		/// allows the drive to be unfozeon from external scripts
		/// </summary>
		public void UnFreezeExternal()
		{
			UnFreeze();
		}

		/// <summary>
		/// allows the drive to be frozen from an external script via a bool
		/// </summary>
		/// <param name="state"></param>
		public void SetFreezeExternal(bool state)
		{
			if (state)
			{
				FreezeExternal();
