...
public class TeleportViveNick : MonoBehaviour {
    ...
    public Valve.VR.InteractionSystem.Hand[] Controllers;
    private Valve.VR.InteractionSystem.Hand ActiveController;
    ...
    public TeleportStateNick CurrentTeleportState { get; private set; }
